...
`rp2-i2c-eeprom` presents an I2C EEPROM (24C32) connected to GP0/GP1 of the Raspberry Pi Pico/Pico2 or Waveshare Core2350B as a USB CDC MSC (Mass Storace Class) device to allow simple reading and writing of the EEPROM.
